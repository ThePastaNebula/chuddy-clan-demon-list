                ...
                <div class="level" v-if="level">
                    ...
                    <table class="records">
                        <tr v-for="record in level.records" class="record">
                            ...
                            <td class="mobile">
                                <img v-if="record.mobile" :src="\`/chuddy-clan-demon-list/assets/phone-landscape\${store.dark ? '-dark' : ''}.svg\`" alt="Mobile">
                            </td>
                        </tr>
                    </table>
                </div>
                    ...
                    <template v-if="editors">
                        ...
                        <ol class="editors">
                            <li v-for="editor in editors">
                                <img :src="\`/chuddy-clan-demon-list/assets/\${roleIconMap[editor.role]}\${store.dark ? '-dark' : ''}.svg\`" :alt="editor.role">
